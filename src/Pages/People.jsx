...
const People = () => {
  return (
      ...
      <div className='bg-red-700'>
        ...
        <img src={LeftPart} alt="" className="absolute left-[35%]" />
        <img src={RightPart} alt="" className="absolute right-[35%]" />
        <img src={shortLeg} alt="" className="absolute left-[49%] bottom-[4%]" />
        <img src={Head} alt="" className="absolute left-[43%] top-[36%]" />

        {/* Left */}
        <img src={LeftPart} alt="" className="absolute bottom-[8%] left-[15%]" />
        <img src={LongLeg} alt="" className="absolute bottom-[8%] left-[30%]" />
        <img src={Head} alt="" className="absolute left-[20%] top-[32%]" />

        {/* right */}
        <img src={RightPart} alt="" className="absolute bottom-[8%] right-[15%]" />
        <img src={LongLeg} alt="" className="absolute bottom-[8%] right-[30%]" />
